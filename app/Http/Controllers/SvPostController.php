...
class SvPostController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('svpost.index',compact('svposts'));
    }
    ...
    public function create()
    {
        ...
        $categories = category::all()->toArray();
        return view('svpost.create',compact('svposttypes','categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $svpost->save();
        return redirect()->route('svpost.index')->with('success','data added');
    }

    /**
     * Display the specified resource.
     *
     * @param  \App\sv_post  $sv_post
     * @return \Illuminate\Http\Response
     */
    public function show(sv_post $sv_post)
    {
    }
    ...
    public function edit($id_svpost)
    {
        ...
        return view('svpost.edit',compact('svposts','id_svpost','svposttypes','categories','selected'));
    }
    ...
    public function update(Request $request, $id_svpost)
    {
        ...
        $svpost->save();
        return redirect()->route('svpost.index')->with('success','data update');
    }
    ...
    public function destroy($id_svpost)
    {
        ...
        $svpost = sv_post::find($id_svpost);
        $svpost->delete();
        return redirect()->route('svpost.index')->with('success','record have deleted');
    }

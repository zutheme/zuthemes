...
class DetailOrderByIdorderProcedure extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::unprepared("
            CREATE PROCEDURE DetailOrderByIdorderProcedure(IN `_idnumberorder` INT(11))
            BEGIN             
    ...
    {
        DB::unprepared('DROP PROCEDURE IF EXISTS DetailOrderByIdorderProcedure');
    }
}

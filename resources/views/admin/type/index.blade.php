   ...
   <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_title">
                   ...
                   <form method="post" action="{{  url('/admin/listpost/'.$posttype) }}">
                      {{ csrf_field() }}
                      ...
                      <div class="col-sm-2 text-center">
                       ...
                       <div class="col-sm-2 text-right">
                        ...
                        <a class="btn btn-default btn-primary" href="{{ action('Admin\PostsController@create',['idposttype'=>3]) }}">Tạo mới</a>
                      </div>
                    </form>
                    <div class="clearfix"></div>
                  </div>

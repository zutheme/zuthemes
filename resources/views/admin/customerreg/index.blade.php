                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
	                ...
	                <tbody>
                      ...
                      <td style="width: 100px !important">{{ $row['created_at'] }}</td>



      								<td style="width: 100px !important">{{ $row['mobile'] }}</td>



      								<td style="width: 100px !important">{{ $row['firstname'] }}</td>

                      <td style="width: 100px !important">{{ $row['address_reg'] }}</td>
                      <td style="width: 100px !important">{{ $row['email'] }}</td>

                       <td style="width: 100px !important;white-space: nowrap">{{ $row['url'] }}</td>

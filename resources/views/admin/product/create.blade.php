...
@section('other_scripts')
	<script src="{{ asset('dashboard/production/js/process_images/capture_image.js?v=0.3.2') }}"></script>
    ...
    <script src="{{ asset('dashboard/production/js/media-galerry.js?v=0.3.4') }}"></script>

				...
				<div class="c-content-product-2 c-bg-white c-border">
					...
					<div class="c-content-overlay">
						...
						<div class="c-overlay-wrapper">
							...
							<div class="c-overlay-content">
								...
								<a href="{{ url('/').'/showpost/'.$curent_posttype.'/'.$row['idproduct'] }}" class="btn btn-md c-btn-grey-1 c-btn-uppercase c-btn-bold c-btn-border-1x c-btn-square">Khám phá</a>
					...
					<div class="btn-group btn-group-justified" role="group">
						...
						<div class="btn-group c-border-top" role="group">
							...
							<a href="{{ url('/').'/showpost/'.$curent_posttype.'/'.$row['idproduct'] }}" class="btn btn-sm c-btn-white c-btn-uppercase c-btn-square c-font-grey-3 c-font-white-hover c-bg-red-2-hover c-btn-product">Xem thêm</a>

						</div>

						<div class="btn-group c-border-left c-border-top" role="group">

							<a href="{{ url('/').'/showpost/'.$curent_posttype.'/'.$row['idproduct'] }}" class="btn btn-sm c-btn-white c-btn-uppercase c-btn-square c-font-grey-3 c-font-white-hover c-bg-red-2-hover c-btn-product">Mua</a>
